...
class MainActivity : AppCompatActivity() {
    ...
    private val chara1 = Character(name = "ディルック",skillList = mutableListOf(
    ...
    private val chara2 = Character(name = "ジン",skillList = mutableListOf(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val charaAdapter = ArrayAdapter(
            ...
            arrayOf(chara1.name,chara2.name)
        )
