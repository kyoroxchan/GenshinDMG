...
class MainActivity : AppCompatActivity() {
    ...
    val characterList: List<Character> = listOf(
        Character(
            name = "ディルック", skillList = mutableListOf(
                Skill(
                    name = "通常攻撃・百煉の剣",
                    normalAttack1 = mutableListOf(
                        0.87,
                        0.97,
                        1.043,
                        1.1473,
                ...
                Skill(
                    name = "逆焔の刃",
                    specialAttackRate1 = mutableListOf(
                        0.944,
                        1.0148,
                        1.0856,
                        1.18,
                    ...
                    specialAttackRate2 = mutableListOf(
                        0.976,
                        1.0492,
                        1.1224,
                        1.22,
                    ...
                    specialAttackRate3 = mutableListOf(
                        1.288,
                        1.3846,
                        1.4812,
                        1.61,
        ...
        Character(
            name = "ジン", skillList = mutableListOf(
                Skill(
                    name = "通常攻撃・西風剣術",
                    normalAttack1 = mutableListOf(
                        0.4833,
...
//                PersonalData(powerNumber, buffNumber, rateNumber, criticalNumber, TalentsNumber)
            ...
            characterList[characterIndex]::class.memberProperties.filter { isFieldAccessible(it) }.forEach { member ->
                println("${member.name} -> ${member.get(example)}")
            }

            val resultDmgDataArrayList =
                arrayListOf<ResultDmgData>(ResultDmgData("攻撃1", "100"), ResultDmgData("攻撃2", "120"))
